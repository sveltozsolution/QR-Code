webpackJsonp(["dynamicdata.module"],{

/***/ "../../../../../src/app/views/dynamicdata/dynamicdata-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DynamicdataRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dynamicdata_component__ = __webpack_require__("../../../../../src/app/views/dynamicdata/dynamicdata.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__dynamicdata_component__["a" /* DynamicdataComponent */],
        data: {
            title: 'Dynamicdata'
        }
    }
...
//    }
// ];
var DynamicdataRoutingModule = /** @class */ (function () {
    function DynamicdataRoutingModule() {
    }
    DynamicdataRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* RouterModule */].forChild(routes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* RouterModule */]]
        })
    ], DynamicdataRoutingModule);
    return DynamicdataRoutingModule;
}());
...
/***/ "../../../../../src/app/views/dynamicdata/dynamicdata.component.css":
...
/***/ "../../../../../src/app/views/dynamicdata/dynamicdata.component.html":
/***/ (function(module, exports) {

module.exports = "<!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->\r\n<div class=\"col-sm-12\">\r\n  <div class=\"col-sm-3\"></div>\r\n  <div class=\"col-sm-6\" style = \"margin-top:70px; margin-left:100px\" >\r\n\r\n    <div *ngFor=\"let key of keys()\" style = \"margin-top:20px\" >\r\n      <label>{{key}}</label>: {{qrdata2[key]}}\r\n    </div>\r\n\r\n  </div>\r\n  <div class=\"col-sm-3\"></div>\r\n</div>"

/***/ }),

/***/ "../../../../../src/app/views/dynamicdata/dynamicdata.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DynamicdataComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
...
var DynamicdataComponent = /** @class */ (function () {
    function DynamicdataComponent(WebService, 
        //  public  userService: MyUserServService, 
        router, location, webservice, route, deviceService) {
    ...
    DynamicdataComponent.prototype.epicFunction = function () {
    ...
    DynamicdataComponent.prototype.ngOnInit = function () {
        ...
        console.log("ip");
        this.WebService.getIpAddress().subscribe(function (data) {
            console.log(data);
            debugger;
            _this.qruserinfo = data._body;
            //  var abc=JSON.parse(data._body); 
            //   debugger; 
            //   alert(abc.ip); 
            //   alert(abc.country_name); 
            _this.userdata = JSON.parse(_this.qruserinfo);
            // this.userdata = JSON.stringify(this.userdata); 
            // this.userdata=JSON.parse(this.userdata); 
            // this.usersdata() 
            _this.ip = _this.userdata.ip;
            _this.country = _this.userdata.country_name;
            _this.city = _this.userdata.city;
            _this.state = _this.userdata.region_name;
            _this.timezone = _this.userdata.time_zone;
            _this.deviceInfo = _this.deviceService.getDeviceInfo();
            _this.browsername = _this.deviceInfo.browser;
            _this.os = _this.deviceInfo.os;
            _this.osversion = _this.deviceInfo.os_version;
            _this.usseragent = _this.deviceInfo.userAgent;
            _this.language = _this.deviceInfo.language;
            _this.createJson2();
    ...
    DynamicdataComponent.prototype.Getid = function () {
        // this.id = "5a8fee91d7f04f0021f60813"
        var _this = this;
        console.log("qrcodeid value");
        console.log(this.id);
        this.webservice.getqrcode(this.id).subscribe(function (qrcode) {
            debugger;
            alert(qrcode.qrtype);
            if (qrcode.qrtype == "url") {
                debugger;
                _this.qrdata2 = qrcode.qrdata;
            }
            else {
                _this.qrdata1 = qrcode.qrdata;
                // var jsonobj = JSON.parse(this.qrdata1);
                _this.qrdata2 = JSON.parse(_this.qrdata1);
            }
        });
    };
    DynamicdataComponent.prototype.keys = function () {
    ...
    //         ); 
    // } 
    DynamicdataComponent.prototype.usersdata = function (qruserinfo, id) {
        this.webservice.postuserdata(qruserinfo, id);
    };
    DynamicdataComponent.prototype.createJson2 = function () {
    ...
    DynamicdataComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-dynamicdata',
            template: __webpack_require__("../../../../../src/app/views/dynamicdata/dynamicdata.component.html"),
            styles: [__webpack_require__("../../../../../src/app/views/dynamicdata/dynamicdata.component.css")],
            providers: [__WEBPACK_IMPORTED_MODULE_2__web_service__["a" /* WebService */], __WEBPACK_IMPORTED_MODULE_5__angular_common_http__["a" /* HttpClient */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__web_service__["a" /* WebService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */], __WEBPACK_IMPORTED_MODULE_4__angular_common__["f" /* Location */], __WEBPACK_IMPORTED_MODULE_2__web_service__["a" /* WebService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_3_ng2_device_detector__["b" /* Ng2DeviceService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dynamicdata_component__ = __webpack_require__("../../../../../src/app/views/dynamicdata/dynamicdata.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dynamicdata_routing_module__ = __webpack_require__("../../../../../src/app/views/dynamicdata/dynamicdata-routing.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_angular2_qrcode__ = __webpack_require__("../../../../angular2-qrcode/lib/angular2-qrcode.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DynamicdataModule = /** @class */ (function () {
    ...
    DynamicdataModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_2__dynamicdata_routing_module__["a" /* DynamicdataRoutingModule */],
                __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormsModule */],
                __WEBPACK_IMPORTED_MODULE_4__angular_common__["b" /* CommonModule */],
                __WEBPACK_IMPORTED_MODULE_5__angular_http__["c" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_7_angular2_qrcode__["b" /* QRCodeModule */],
                __WEBPACK_IMPORTED_MODULE_6_ng2_device_detector__["a" /* Ng2DeviceDetectorModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_2__dynamicdata_routing_module__["a" /* DynamicdataRoutingModule */]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_1__dynamicdata_component__["a" /* DynamicdataComponent */]
            ]
        })
    ], DynamicdataModule);
...
//# sourceMappingURL=dynamicdata.module.chunk.js.map